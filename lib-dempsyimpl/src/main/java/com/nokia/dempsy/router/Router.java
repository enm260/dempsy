...
public class Router implements Dispatcher, RoutingStrategy.Outbound.Coordinator {
        ...
        synchronized (outbound) {
            ...
            if (classes != null && classes.size() > 0) {
                ...
                if (curClusterDef != null) {
                    ...
                    final ClusterRouter clusterRouter = new ClusterRouter((Serializer<Object>) curClusterDef.getSerializer(), outbound);
    ...
    protected class ClusterRouter {
        ...
        private ClusterRouter(final Serializer<Object> serializer, final Outbound strategyOutbound) {
