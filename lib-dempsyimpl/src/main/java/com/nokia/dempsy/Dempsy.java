...
public class Dempsy {
            ...
            public class Node {
                ...
                private void start() throws DempsyException {
                    try {
                        ...
                        final Serializer<Object> serializer = (Serializer<Object>) clusterDefinition.getSerializer();
                        if (serializer != null)
    ...
    public void setDefaultSerializer(final Serializer<Object> defaultSerializer) {
