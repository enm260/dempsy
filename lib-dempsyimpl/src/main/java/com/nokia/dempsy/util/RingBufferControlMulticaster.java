 ...
 * in a "single-publisher to multi-consumer" thread configuration where everything
 * published is "multicast" to all consumers.</p> 
 */
public class RingBufferControlMulticaster
{
   ...
   public RingBufferControlMulticaster(int numberOfSubscribers, int sizePowerOfTwo)
    ...
    * returned should be supplied to the {@link RingBufferControlMulticaster#publish(long)}
    ...
    * {@link RingBufferControlMulticaster#claim(int)} call.
    */
