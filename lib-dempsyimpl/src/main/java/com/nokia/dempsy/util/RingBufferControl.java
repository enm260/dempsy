 ...
 * separate classes. This class represents control of the publish side of the ring buffer
 * however, it inherits from the {@link RingBufferConsumerControl} which represents the
 * consumer side.</p> 
 * 
...
public class RingBufferControl extends RingBufferConsumerControl
{
    ...
    * @param sizePowerOfTwo is the size of the buffer being controlled. It must be a 
    * power of 2.
    * @param waitStrategy is the implementation of {@link RingBufferControl#waitStrategy}
    * to use.
    * @throws IllegalArgumentException if the sizePowerOfTwo isn't a power of 2.
    */
   public RingBufferControl(final int sizePowerOfTwo, ConsumerWaitStrategy waitStrategy)
   ...
   {
      long curNextValue = pubHeadAndTailCache.nextValue;
      long nextSequence = curNextValue + requestedNumberOfSlots;
      long wrapPoint = nextSequence - bufferSize;
      long cachedGatingSequence = pubHeadAndTailCache.tailCache;
    ...
    * @param sequence is the sequence returned from the {@link RingBufferControl#claim(int)}
    * call.
    */
